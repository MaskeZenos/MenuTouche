...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "mpleaderboard12", Texture = "leaderboard_female_icon", X = 215, Y = 0, Width = 40, Height = 40 },
    RightArrow = { Dictionary = "mpleaderboard12", Texture = "leaderboard_male_icon", X = 395, Y = 0, Width = 40, Height = 40 },
}
